    ...
    public partial class FirstMigration : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        OpenOrClosed = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Location", t => t.LocationID, cascadeDelete: false) //modify the foreign key relationships. It should stay as it is No matter what. Check the Foreign Key relationships.Make sure you dont delete in both ways.
